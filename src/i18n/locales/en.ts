...
const en: Record<string, string> = {
  ...
  'settings.vector.source.openrouter': 'OpenRouter',
  'settings.vector.openrouterApiKey': 'OpenRouter API key',
  'settings.vector.openrouterApiKeyDesc': 'Get one at openrouter.ai/keys. Stored locally; only sent to https://openrouter.ai.',
  'settings.vector.openrouterModel': 'Embedding model',
  'settings.vector.openrouterModelCustom': 'Custom model…',
  'settings.vector.openrouterModelCustomLabel': 'Custom model slug',
